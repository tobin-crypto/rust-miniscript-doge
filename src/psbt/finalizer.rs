...
use dogecoin::{self, PublicKey, Script};
...
fn get_descriptor(psbt: &Psbt, index: usize) -> Result<Descriptor<PublicKey>, InputError> {
    ...
    if script_pubkey.is_p2pk() {
        ...
        match dogecoin::PublicKey::from_slice(&pk_bytes[1..script_pubkey_len - 1]) {
        ...
        let partial_sig_contains_pk = inp
            ...
            .filter(|&(&pk, _sig)| {
                ...
                let addr = dogecoin::Address::p2pkh(&pk, dogecoin::Network::Bitcoin);
        ...
        let partial_sig_contains_pk = inp
            ...
            .filter(|&(&pk, _sig)| {
                // Indirect way to check the equivalence of pubkey-hashes.
                // Create a pubkey hash and check if they are the same.
                let addr = dogecoin::Address::p2wpkh(&pk, dogecoin::Network::Bitcoin)
        ...
        if let Some(ref witness_script) = inp.witness_script {
            ...
            let ms = Miniscript::<dogecoin::PublicKey, Segwitv0>::parse_insane(witness_script)?;
            ...
            &Some(ref redeem_script) => {
                ...
                if redeem_script.is_v0_p2wsh() {
                    ...
                    if let Some(ref witness_script) = inp.witness_script {
                        ...
                        let ms = Miniscript::<dogecoin::PublicKey, Segwitv0>::parse_insane(
                            witness_script,
                        )?;
                    ...
                    if let Some(ref redeem_script) = inp.redeem_script {
                        let ms =
                            Miniscript::<dogecoin::PublicKey, Legacy>::parse_insane(redeem_script)?;
        ...
        let ms = Miniscript::<dogecoin::PublicKey, BareCtx>::parse_insane(script_pubkey)?;
...
pub fn finalize<C: secp256k1::Verification>(
    ...
    for (n, input) in psbt.inputs.iter().enumerate() {
        let target = input.sighash_type.unwrap_or(dogecoin::SigHashType::All);
        for (key, rawsig) in &input.partial_sigs {
            ...
            let flag = dogecoin::SigHashType::from_u32_standard(*flag as u32).map_err(|_| {
...
mod tests {
    ...
    fn tests_from_bip174() {
        let mut psbt: dogecoin::util::psbt::PartiallySignedTransaction = deserialize(&Vec::<u8>::from_hex("").unwrap()).unwrap();

        let secp = Secp256k1::verification_only();
        finalize(&mut psbt, &secp).unwrap();

        let expected: dogecoin::util::psbt::PartiallySignedTransaction = deserialize(&Vec::<u8>::from_hex("").unwrap()).unwrap();
